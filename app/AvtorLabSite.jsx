...
const COPY = {
  uk: {
    brand: "Avtor Lab",
    topbar: {
      tagline: "Преміальні реставрації • B2B-фрезерування",
      call: "Подзвонити",
      email: "Написати",
    },
    nav: {
    ...
    hero: {
      title: "Преміальні реставрації та точне B2B-фрезерування",
      subtitle:
      ...
      badges: ["Стабільні терміни", "Контроль якості", "Підтримка лікаря", "Точність роботи"],
    },
    services: {
      title: "Послуги",
      subtitle:
        "Працюємо за сучасними та класичними підходами. Підбираємо матеріали під задачу та бюджет.",
      items: [
        ...
        { title: "Фрезерний центр (B2B)", desc: "Фрезерування STL/Exocad: цирконій, PMMA, титан (за ТЗ).", img: "" },
      ],
    },
    partners: {
      title: "Партнерам",
    ...
    education: {
      ...
      subtitle: "Ділимось практикою, розбираємо складні кейси та допомагаємо лікарям.",
      cards: [
    ...
    calculator: {
      ...
      types: [
        ...
        { key: "b2b", label: "Фрезерний центр (B2B)", days: 3 },
      ],
  ...
  ru: {
    brand: "Avtor Lab",
    topbar: {
      tagline: "Премиальные реставрации • B2B-фрезеровка",
      call: "Позвонить",
      email: "Написать",
    },
    nav: {
    ...
    hero: {
      title: "Премиальные реставрации и точная B2B-фрезеровка",
      subtitle:
      ...
      badges: ["Стабильные сроки", "Контроль качества", "Поддержка врача", "Точность работы"],
    },
    services: {
      title: "Услуги",
    ...
    education: {
      ...
      subtitle: "Разбор кейсов и практическая поддержка врачей.",
      cards: [
  ...
  en: {
    brand: "Avtor Lab",
    topbar: {
      tagline: "Premium restorations • B2B milling",
      call: "Call",
      email: "Email",
    },
    nav: {
    ...
    hero: {
      title: "Premium restorations and precise B2B milling",
      subtitle:
        ...
        <div className="grid gap-10 md:grid-cols-2 md:items-center">
          <div>
            ...
            <div className="mt-6 flex items-center gap-3 text-xs text-neutral-400">
              ...
              <span>QC • Digital workflow • B2B</span>
            </div>
          </div>
              ...
              <CardContent className={`text-sm ${ON_LIGHT_TEXT}`}>
                <ul className="space-y-2">
                  <li className="flex items-center gap-2">
                    <Check className="h-4 w-4" /> Scan / impressions
                  </li>
                  <li className="flex items-center gap-2">
                    <Check className="h-4 w-4" /> Design / approval
                  </li>
                  <li className="flex items-center gap-2">
                    <Check className="h-4 w-4" /> Milling / QC
                  </li>
                  <li className="flex items-center gap-2">
                    <Check className="h-4 w-4" /> Delivery / support
                  </li>
                </ul>
              </CardContent>
            </Card>
      ...
      <div className="grid gap-6 md:grid-cols-2 md:items-start">
        <Card className={PANEL}>
          ...
          <CardContent className={`text-sm ${ON_LIGHT_TEXT}`}>
            ...
            <div className="mt-6">
              <Button className="gap-2 bg-black text-white hover:bg-neutral-900" type="button">
    ...
    <Section id="contact" title={t.contact.title} subtitle={t.contact.subtitle}>
      <div className="grid gap-6 md:grid-cols-2">
          ...
          <CardContent>
            <form onSubmit={onSubmit} className="grid gap-4">
              <div className="grid gap-3 sm:grid-cols-2">
                <div className="grid gap-2">
                  <label className="text-sm text-black">{t.contact.name}</label>
                  <Input placeholder={t.contact.name} />
                </div>
                <div className="grid gap-2">
                  <label className="text-sm text-black">{t.contact.clinic}</label>
                  <Input placeholder={t.contact.clinic} />
                </div>
              </div>

              <div className="grid gap-3 sm:grid-cols-2">
                <div className="grid gap-2">
                  <label className="text-sm text-black">{t.contact.phone}</label>
                  <Input placeholder={t.contact.phone} />
                </div>
                <div className="grid gap-2">
                  <label className="text-sm text-black">{t.contact.email}</label>
                  <Input type="email" placeholder={t.contact.email} />
                </div>
              </div>

              <div className="grid gap-2">
                <label className="text-sm text-black">{t.contact.message}</label>
                <Textarea placeholder={t.contact.message} rows={5} />
              </div>

              <div className="grid gap-2">
                <label className="text-sm flex items-center gap-2 text-black">
                  <Upload className="h-4 w-4" /> {t.contact.attach}
                </label>
                <Input type="file" multiple onChange={(e) => setFilesCount((e.target.files || []).length)} />
                {filesCount ? <div className="text-xs text-neutral-500">{filesCount} file(s) selected</div> : null}
              </div>

              <label className="flex items-center gap-2 text-sm text-neutral-700">
                <input type="checkbox" required /> {t.contact.consent}
              </label>

              <Button className="gap-2 bg-black text-white hover:bg-neutral-900" type="submit">
                <Send className="h-4 w-4" /> {t.contact.send}
              </Button>

              {sent ? <div className="text-sm text-green-700">{t.contact.sent}</div> : null}
            </form>
          </CardContent>
        </Card>
        ...
        <div className="grid gap-4">
          ...
          <div className="rounded-2xl border border-neutral-200 bg-white p-5 text-sm text-black">
            <div className="flex items-center gap-2 font-semibold">
              <FileText className="h-4 w-4" /> Notes
            </div>
            <div className="mt-2 text-neutral-600">
              Upload STL/photos if available. We’ll confirm protocol, pricing and lead time.
            </div>
          </div>
        </div>
      </div>
